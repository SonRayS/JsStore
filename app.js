  ...
  console.log('node express work on 3000');
          ...
          app.get('/catalog', function (req, res){
              ...
              console.log("Connected!");
                        ...
                        let nap = new Promise(function (resolve, reject) {
                            con.query("SELECT * FROM goods WHERE category = 'Наповювачі'", 
                          ...
                          let korm = new Promise(function (resolve, reject) {
                            con.query("SELECT * FROM goods WHERE category = 'Корм'",
                            function (error, result) {
                              if (error) reject(error);
                              resolve(result);
                        ...
                        let game = new Promise(function (resolve, reject) {
                          con.query("SELECT * FROM goods WHERE category = 'Іграшки'",
                          function (error, result) {
                            if (error) reject(error);
                            resolve(result);
                      ...
                      let homes = new Promise(function (resolve, reject) {
                        con.query("SELECT * FROM goods WHERE category = 'Будиночки' ",
                        function (error, result) {
                          if (error) reject(error);
                          resolve(result);
                    ...
                    let bed = new Promise(function (resolve, reject) {
                      con.query("SELECT * FROM goods WHERE category = 'Лежаки'",
                        function (error, result) {
                          if (error) reject(error);
                          resolve(result);
